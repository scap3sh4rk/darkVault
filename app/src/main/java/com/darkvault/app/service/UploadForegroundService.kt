        ...
        scope.launch {
            ...
            while (UploadState.queue.isNotEmpty()) {
                ...
                try {
                    ...
                    // Start resumable session — include clientId for idempotency (Task 8)
                    ...
                    // Emit rename event if name changed, then completed
                    if (wasRenamed) {
